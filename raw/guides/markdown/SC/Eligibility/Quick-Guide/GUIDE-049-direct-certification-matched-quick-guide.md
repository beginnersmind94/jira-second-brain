...
curated_against_raw_sha: "93cdedca77b2956a"
...
> Seeded from the raw extraction. Edit freely. When the raw drifts, review the diff and update this file, then mark it reviewed with `python scripts/mark_guide_reviewed.py GUIDE-049`.
...
3. Click the SEARCH button
   ...
   The Matched grid includes Address, Guardian, Current Eligibility, Prior Eligibility, and Household PIN columns. Sorting and filtering are available for the new columns, and the export reflects them.
   Search filters are also available on the Match Method and Extension Criteria columns.
