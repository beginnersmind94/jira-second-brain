...
source_url: "https://s3.us-east-1.amazonaws.com/docs.schoolcafe.com/System/Operation_Onboarding_Quick_Guide.pdf"
local_pdf: "raw/guides/pdf/SC/System/Quick-Guide/GUIDE-001-system-onboarding-quick-guide.pdf"
curated_against_raw_sha: "98fec23e35e18bb2"
curated_against_raw_at: "2026-05-18T20:39:35+00:00"
last_reviewed_by: ""
status: "needs_initial_review"
---

# System Onboarding Quick Guide

> Seeded from the raw extraction. Edit freely. When the raw drifts, review the diff and update this file, then mark it reviewed with `python scripts/mark_guide_reviewed.py GUIDE-001`.

Users will follow these steps to complete SchoolCafé setup for their district. This guide will include the Site Configuration, Users, Roles and Permissions, Program Configuration, Settings, Periods, and Special Assistance Program functions.

## Site Configuration
The Site Configuration function allows users to manage Sites, Site Types, Grade Groups, and POS Configuration within their district.
...
6. Click the SAVE button in the bottom right corner to add the user
   ...
   The added user will receive an email notification prompting them to set up their
...
7. Click the Reimbursement toggle switch on if the Meal Type is reimbursable
   A confirmation response appears atop the page, and the Site(s) are updated successfully.
...
7. Click the Include Date Range in Period Name checkbox to view the dates in the
   Period name
